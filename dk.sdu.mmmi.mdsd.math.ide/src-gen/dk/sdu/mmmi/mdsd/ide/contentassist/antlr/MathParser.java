...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMathExpAccess().getNextExpAssignment_5(), "rule__MathExp__NextExpAssignment_5");
			...
			builder.put(grammarAccess.getLetBindingAccess().getFirstAssignment_4(), "rule__LetBinding__FirstAssignment_4");
			builder.put(grammarAccess.getLetBindingAccess().getSecondAssignment_6(), "rule__LetBinding__SecondAssignment_6");
