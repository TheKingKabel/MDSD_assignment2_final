 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.MathExp#getNextExp <em>Next Exp</em>}</li>
 * </ul>
 *
...
public interface MathExp extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Next Exp</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Next Exp</em>' containment reference.
   * @see #setNextExp(MathExp)
   * @see dk.sdu.mmmi.mdsd.math.MathPackage#getMathExp_NextExp()
   * @model containment="true"
   * @generated
   */
  MathExp getNextExp();
  ...
  /**
   * Sets the value of the '{@link dk.sdu.mmmi.mdsd.math.MathExp#getNextExp <em>Next Exp</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Next Exp</em>' containment reference.
   * @see #getNextExp()
   * @generated
   */
  void setNextExp(MathExp value);
