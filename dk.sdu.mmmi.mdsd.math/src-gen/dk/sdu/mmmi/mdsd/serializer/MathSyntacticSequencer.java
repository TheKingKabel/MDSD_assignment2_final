...
public class MathSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_MathExp_EOLTerminalRuleCall_4_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_MathExp_EOLTerminalRuleCall_4_q = new TokenAlias(false, true, grammarAccess.getMathExpAccess().getEOLTerminalRuleCall_4());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_MathExp_EOLTerminalRuleCall_4_q.equals(syntax))
				emit_MathExp_EOLTerminalRuleCall_4_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     exp=Exp (ambiguity) (rule end)
	 *     exp=Exp (ambiguity) nextExp=MathExp
	 */
	protected void emit_MathExp_EOLTerminalRuleCall_4_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
